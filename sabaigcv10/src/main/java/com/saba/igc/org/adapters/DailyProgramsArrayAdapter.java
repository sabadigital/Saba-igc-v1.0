 ...
 * @version 1.0
 */
public class DailyProgramsArrayAdapter extends ArrayAdapter<DailyProgram>{

	public DailyProgramsArrayAdapter(Context context, List<DailyProgram> objects) {
		super(context, R.layout.daily_program_item, objects);
	}
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(getContext()).inflate(R.layout.daily_program_item, parent, false);
